...
if ($data = $this->request->getPostData()) {
    ...
    if ($sub->save()) {
        ...
        Submission::sendToModeration(['challenge_id' => $cha->id, 'player_id' => $player_id]);        $this->request->session()->set('message', 'Run submitted for scoring and moderation. Thank you!');
        return $this->request->redirect('/');
    }
}
...
<form method="POST">
    ...
    <fieldset>
        ...
        <br />
        <input type="submit" value="Submit Run" /cca>
    </fieldset>
    <br />
